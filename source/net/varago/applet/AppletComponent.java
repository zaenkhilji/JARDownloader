...
public class AppletComponent extends JPanel {
	...
	/** The font. */
	private final Font font = new Font("Helvetica", 1, 13);
	...
	public void paintComponent(Graphics g) {
		...
		g.fillRect(65384 + width / 2 + 2, 2 + height / 2 + -18, -3 + 303 * this.percentage / 100, 30);

		String formattedMessage = this.message + " - " + this.percentage + "%";
		g.setColor(Color.WHITE);
		g.drawString(formattedMessage, (-this.fontMetrics.stringWidth(formattedMessage) + width) / 2, 4 + height / 2);
	}
	 ...
	 *
	 * @param percentage the new percentage and repaint
	 */
	 ...
	 *
	 * @param message the new message and repaint
	 */
